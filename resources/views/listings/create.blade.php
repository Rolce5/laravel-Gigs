...
<x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            <label for="tags" class="inline-block text-lg mb-2">Tag (Comma Separated)</label>
        ...
        <div class="mb-6">
            ...
            <textarea class="border border-gray-200 rounded p-2 w-full" name="description" {{old('description')}} rows="10" placeholder="Include tasks, requirements, salary, etc"></textarea>
            @error('description')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
        @enderror 
        </div>
